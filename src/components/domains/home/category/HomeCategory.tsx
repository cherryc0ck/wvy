    ...
    <S.Section>
      ...
      {currentMenu === "NEW IN" && (
        <S.CategoryListWrapper>
          <HomeCategoryList list={CATEGORY_ITEMS.new.first} />
          <HomeCategoryList list={CATEGORY_ITEMS.new.second} />
        </S.CategoryListWrapper>
      )}
      {currentMenu === "의류" && (
        <S.CategoryListWrapper>
          <HomeCategoryList list={CATEGORY_ITEMS.clothes.first} />
          <HomeCategoryList list={CATEGORY_ITEMS.clothes.second} />
        </S.CategoryListWrapper>
      )}
      {currentMenu === "가방" && (
        <S.CategoryListWrapper>
          <HomeCategoryList list={CATEGORY_ITEMS.bag.first} />
          <HomeCategoryList list={CATEGORY_ITEMS.bag.second} />
        </S.CategoryListWrapper>
      )}
      {currentMenu === "주얼리" && (
        <S.CategoryListWrapper>
          <HomeCategoryList list={CATEGORY_ITEMS.jewelry.first} />
          <HomeCategoryList list={CATEGORY_ITEMS.jewelry.second} />
        </S.CategoryListWrapper>
      )}
    </S.Section>
  );
